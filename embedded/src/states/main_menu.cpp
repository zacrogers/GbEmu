...
MenuState::MenuState()
{
    ...
    // lv_obj_add_style(main_screen, &main_style, LV_PART_MAIN);
    // lv_obj_t* ui_Game_Select_Dropdown = lv_dropdown_create(main_screen);
    ...
    ui_Start_Game_Button = lv_btn_create(main_screen);
    ...
    ui_Start_Game_Label = lv_label_create(ui_Start_Game_Button);
...
MenuState::~MenuState()
{
    ...
    lv_obj_clean(ui_Start_Game_Button);
    lv_obj_clean(ui_Start_Game_Label);
