...
//  0x70
 ...
 //0x8X
    [0x80] = { MN::ADD,   AM::R_R,    R::A,     R::B},
    [0x81] = { MN::ADD,   AM::R_R,    R::A,     R::C},
    [0x82] = { MN::ADD,   AM::R_R,    R::A,     R::D},
    [0x83] = { MN::ADD,   AM::R_R,    R::A,     R::E},
    [0x84] = { MN::ADD,   AM::R_R,    R::A,     R::H},
    [0x85] = { MN::ADD,   AM::R_R,    R::A,     R::L},
    [0x86] = { MN::ADD,   AM::R_MR,   R::A,     R::HL},
    [0x87] = { MN::ADD,   AM::R_R,    R::A,     R::A},
    [0x88] = { MN::ADC,   AM::R_R,    R::A,     R::B},
    [0x89] = { MN::ADC,   AM::R_R,    R::A,     R::C},
    [0x8A] = { MN::ADC,   AM::R_R,    R::A,     R::D},
    [0x8B] = { MN::ADC,   AM::R_R,    R::A,     R::E},
    [0x8C] = { MN::ADC,   AM::R_R,    R::A,     R::H},
    [0x8D] = { MN::ADC,   AM::R_R,    R::A,     R::L},
    [0x8E] = { MN::ADC,   AM::R_MR,   R::A,     R::HL},
    [0x8F] = { MN::ADC,   AM::R_R,    R::A,     R::A},
    ...
    [0xC9] = { MN::RET,   AM::None,   R::None,  R::None,  4,    2, 0, "RRCA"  },
    [0xCA] = { MN::JP,    AM::D16,    R::None,  R::None },
    [0xCB] = { MN::CB,    AM::D8,     R::None,  R::None,  4,    2, 0, "RRCA" },
    [0xCC] = { MN::CALL,  AM::D16,    R::None,  R::None },
    [0xCD] = { MN::CALL,  AM::D16,    R::None,  R::None,  4,    2, 0, "RRCA" },
