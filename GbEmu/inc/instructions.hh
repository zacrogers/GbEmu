...
//  0x60
    [0x60] = { MN::LD,    AM::R_R,    R::H,     R::B,     4,    1, 0, "LD B,B"      },
    [0x61] = { MN::LD,    AM::R_R,    R::H,     R::C,     4,    1, 0, "LD B,B"      },
    [0x62] = { MN::LD,    AM::R_R,    R::H,     R::D,     4,    1, 0, "LD B,B"      },
    [0x63] = { MN::LD,    AM::R_R,    R::H,     R::E,     4,    1, 0, "LD B,B"      },
    [0x64] = { MN::LD,    AM::R_R,    R::H,     R::H,     4,    1, 0, "LD B,B"      },
    [0x65] = { MN::LD,    AM::R_R,    R::H,     R::L,     4,    1, 0, "LD B,B"      },
    [0x66] = { MN::LD,    AM::R_MR,   R::H,     R::HL,    4,    1, 0, "LD B,B"      },
    [0x67] = { MN::LD,    AM::R_R,    R::H,     R::A,     4,    1, 0, "LD B,B"      },
    [0x68] = { MN::LD,    AM::R_R,    R::L,     R::B,     4,    1, 0, "LD B,B"      },
    [0x69] = { MN::LD,    AM::R_R,    R::L,     R::C,     4,    1, 0, "LD B,B"      },
    [0x6A] = { MN::LD,    AM::R_R,    R::L,     R::D,     4,    1, 0, "LD B,B"      },
    [0x6B] = { MN::LD,    AM::R_R,    R::L,     R::E,     4,    1, 0, "LD B,B"      },
    [0x6C] = { MN::LD,    AM::R_R,    R::L,     R::H,     4,    1, 0, "LD B,B"      },
    [0x6D] = { MN::LD,    AM::R_R,    R::L,     R::L,     4,    1, 0, "LD B,B"      },
    [0x6E] = { MN::LD,    AM::R_MR,   R::L,     R::HL,    4,    1, 0, "LD B,B"      },
    [0x6F] = { MN::LD,    AM::R_R,    R::L,     R::A,     4,    1, 0, "LD B,B"      },

//  0x70
    [0x70] = { MN::LD,    AM::MR_R,   R::HL,    R::B,     4,    1, 0, "LD [HL],B"   },
    [0x71] = { MN::LD,    AM::MR_R,   R::HL,    R::C,     4,    1, 0, "LD [HL],B"   },
    [0x72] = { MN::LD,    AM::MR_R,   R::HL,    R::D,     4,    1, 0, "LD [HL],B"   },
    [0x73] = { MN::LD,    AM::MR_R,   R::HL,    R::E,     4,    1, 0, "LD [HL],B"   },
    [0x74] = { MN::LD,    AM::MR_R,   R::HL,    R::H,     4,    1, 0, "LD [HL],B"   },
    [0x75] = { MN::LD,    AM::MR_R,   R::HL,    R::L,     4,    1, 0, "LD [HL],B"   },
    [0x76] = { MN::HALT,  AM::None,   R::None,  R::None,  4,    2, 0, "RRCA"        },
    [0x77] = { MN::LD,    AM::MR_R,   R::HL,    R::A,     4,    1, 0, "LD [HL],B"   },
    [0x78] = { MN::LD,    AM::R_R,    R::A,     R::B,     4,    1, 0, "LD A,B"      },
    [0x79] = { MN::LD,    AM::R_R,    R::A,     R::C,     4,    1, 0, "LD A,B"      },
    [0x7A] = { MN::LD,    AM::R_R,    R::A,     R::D,     4,    1, 0, "LD A,B"      },
    [0x7B] = { MN::LD,    AM::R_R,    R::A,     R::E,     4,    1, 0, "LD A,B"      },
    [0x7C] = { MN::LD,    AM::R_R,    R::A,     R::H,     4,    1, 0, "LD A,B"      },
    [0x7D] = { MN::LD,    AM::R_R,    R::A,     R::L,     4,    1, 0, "LD A,B"      },
    [0x7E] = { MN::LD,    AM::R_MR,   R::A,     R::HL,    4,    1, 0, "LD A,[HL]"   },
    [0x7F] = { MN::LD,    AM::R_R,    R::A,     R::A,     4,    1, 0, "LD A,B"      },
